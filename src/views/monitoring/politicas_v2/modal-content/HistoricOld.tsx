...
import { usePolicy } from "../../politicas/hooks/usePolicy"
import { IPolicyHistoryDetail } from "./../../politicas/Types"
import { ComboBoxInput } from "../../../../components/Inputs/ComboBoxInputs"
import { HistoricalChangesColumns } from "../../politicas/modal-content/historicalChanges/historicalChangesColumns"
...
const HistoricChangesOld = () => {

  //const { closeModal, modalInformation } = useContext<ContextProps>(ContextPolitica)
  const { modalHook: { closeModal, modalInformation } } = useMonitoringPoliciesContext()
