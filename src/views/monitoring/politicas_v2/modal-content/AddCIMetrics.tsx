...
import { CIsInVersion, MetricFamilyClase, MetricParameter, MetricVersionFront } from "../Types";
...
export const AddCIMetrics = () => {
    const { modalHook, catalogHook, globalParams } = useMonitoringPoliciesContext()
    const userName = useTypedSelector(({ auth }) => auth.usuario)
    const { ci, setUpdates }: ModalInformationProps = modalHook.modalInformation
    ...
    const handleSubmit = () => {
        ...
        const selectedToolObj = catalogHook.tools.find(tool => tool.nombre.toUpperCase() === selectedTool.toUpperCase());
        const date = new Date();
        ...
        setUpdates(prev => [...prev, ...transformedMetrics]);
        ...
        <>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="input-group input-group-solid">
                                    ...
                                    <select
                                        ...
                                        disabled={catalogHook.toolsLoading}
                                        required
                                    >
                                        <option value="">{catalogHook.toolsLoading ? 'Cargando...' : 'Todas las herramientas'}</option>
            ...
            <div className="modal-footer">
                ...
                <button
                    ...
                    disabled={catalogHook.familyClaseMetricsLoading || !selectedIP || !selectedTool || !Object.keys(selectedMetrics).some(k => selectedMetrics[Number(k)])}
                >
                    {catalogHook.familyClaseMetricsLoading ? (
