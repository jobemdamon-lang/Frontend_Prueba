...
const MssqlDBForm: FC<Props> = ({ setGenericChangesInPolicy, selectedRow, setView, setGenericChangeFront, selectedMetric }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="d-flex flex-wrap gap-5 m-5 justify-content-center">
        <div className="w-25">
          <label htmlFor="nombre_db">Nombre DB</label>
          <input
            name="nombre_db"
            value={metricOptionalToCreate.nombre_db}
            type="text"
            required
