...
const AvailabilityWeb: FC<Props> = ({ setGenericChangesInPolicy, selectedRow, setView, setGenericChangeFront, selectedMetric }) => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="d-flex flex-wrap gap-5 m-5 justify-content-center">
                <div className="w-25">
                    <label htmlFor="name_web">Nombre Web</label>
                    <input
                        name="name_web"
                        value={metricOptionalToCreate.name_web}
                        type="text"
                        required
