...
const DisponibilidadInterfaz: FC<Props> = ({ setGenericChangesInPolicy, selectedRow, setView, setGenericChangeFront, selectedMetric }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="d-flex flex-wrap gap-5 m-5 justify-content-center">
        <div className="w-25">
          <label htmlFor="name_interface">NOMBRE DE INTERFAZ</label>
          <input
            name="name_interface"
            value={metricOptionalToCreate.nombre_interfaz}
            type="text"
            required
