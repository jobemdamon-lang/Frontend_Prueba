...
const MSSQLAllReplica: FC<Props> = ({ setGenericChangesInPolicy, selectedRow, setView, setGenericChangeFront, selectedMetric }) => {
        ...
        <form onSubmit={handleSubmit}>
            <div className="d-flex flex-wrap gap-5 m-5 justify-content-center">
                <div className="w-25">
                    ...
                    <input
                        name="all_replicas"
                        value={metricOptionalToCreate.all_replicas}
                        type="text"
                        required
