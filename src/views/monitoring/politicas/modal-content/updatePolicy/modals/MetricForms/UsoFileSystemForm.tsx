...
const UsoFileSystemForm: FC<Props> = ({ setGenericChangesInPolicy, selectedRow, setView, setGenericChangeFront, selectedMetric }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="d-flex flex-wrap gap-5 m-5 justify-content-center">
        <div className="w-25">
          <label htmlFor="metrica_ruta">RUTA DE DISCO ASOCIADA</label>
          <input
            name="metrica_ruta"
            value={metricOptionalToCreate.metrica_ruta}
            type="text"
            required
