...
const MSSQLPrimaryReplica: FC<Props> = ({ setGenericChangesInPolicy, selectedRow, setView, setGenericChangeFront, selectedMetric }) => {
            ...
            <div className="d-flex flex-wrap gap-5 m-5 justify-content-center">
                <div className="w-25">
                    ...
                    <input
                        ...
                        value={metricOptionalToCreate.primary_replicas}
                        type="text"
                        required
