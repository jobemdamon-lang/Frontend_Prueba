...
const MSSQLSomeReplica: FC<Props> = ({ setGenericChangesInPolicy, selectedRow, setView, setGenericChangeFront, selectedMetric }) => {
        ...
        <form onSubmit={handleSubmit}>
            <div className="d-flex flex-wrap gap-5 m-5 justify-content-center">
                <div className="w-25">
                    ...
                    <input
                        name="some_replicas"
                        value={metricOptionalToCreate.some_replicas}
                        type="text"
                        required
