...
const DespriorizationConfirm = () => {

    const { modalHook, useIncidentHook, useTicketHook, rol } = useIncidentContext()
    ...
    return (
        <>
            ...
            <div className='modal-body px-lg-10'>
                <p className="text-center fs-3">¿Esta seguro que desea DESPRIORIZAR esta incidencia | {modalInformation.TicketIdentifier}?</p>
                ...
                <div className="d-flex justify-content-center align-items-center gap-8 m-10">
                    <div className="symbol symbol-50px">
                        <div className="symbol-label fs-1 fw-bold bg-dark text-inverse-dark">P1</div>
                    </div>
                    <div>
                    ...
                    <div className="symbol symbol-50px">
                        <div className="symbol-label fs-2 fw-bold bg-primary text-inverse-primary">P2</div>
                    </div>
                </div>
                <div className="d-flex justify-content-around my-5 gap-5">
                    ...
                    >
                        ...
                        >
                            {useIncidentHook.changePriorityLoading ? "Procesando.." : "Despriorizar"}
                        </button>
                    </AccessController>
                    <button
                        type="button"
