...
const CreateRelationFamilyClase = () => {
    ...
    const handleCreateRelation = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (fc_parent && fc_son) {
            familyclaseHook.createRelationFamilyClase({
    ...
    return (
        <>
            <div className='modal-header px-5 py-3'>
                <h2 className="text-dark">Crear Relacion Familia Clase</h2>
                ...
                <form className="d-flex flex-column gap-5" onSubmit={handleCreateRelation}>
                    ...
                    <div className="d-flex justify-content-end align-items-center gap-10 mt-5">
                        <button
                            ...
                            disabled={familyclaseHook.loadingCreateRelationFamilyClase}
                        >
                            {familyclaseHook.loadingCreateRelationFamilyClase ? "Creando" : "Crear"}
                        </button>
...
export { CreateRelationFamilyClase }