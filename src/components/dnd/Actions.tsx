...
export function Remove(props: Props) {
    return (
        ...
        >
            <svg width="10" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
...
export function Info(props: Props) {
    return (
        ...
        >
            ...
            >
                <svg width="16" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
